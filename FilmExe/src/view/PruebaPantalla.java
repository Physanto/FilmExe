...
public class PruebaPantalla extends javax.swing.JFrame {
	...
	/**
	 * Creates new form PruebaPantalla
	 */
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(PruebaPantalla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new PruebaPantalla().setVisible(true);
			}
		});
	}
